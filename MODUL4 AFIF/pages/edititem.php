...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="list.php">Mycar</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <img src="../asset/gambar/<?=$item['foto_mobil']?>" class="img-fluid">
                </div>
                <div class="col-lg-6">
                    <form method="post" action="../config/updatepipunk.php" enctype="multipart/form-data">
